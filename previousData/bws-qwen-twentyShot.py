...
for idx, dev_item in enumerate(dev_items):
    ...
    # Retrieve top 20 similar train nodes for few-shot examples
...
with open('rag4re_predictions_20shot_rag.json', 'w') as out_f:
    json.dump(outputs, out_f, indent=2)

# Evaluation
wandb.init(project="relation-extraction", name="RAG4RE_20shot_RAG")
...
print(f"\nEvaluation RESULTS for 20-shot + RAG prompting:")
...
excel_filename = 'relation_extraction_results_20shot_rag.xlsx'
