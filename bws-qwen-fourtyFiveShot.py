...
for idx, dev_item in enumerate(dev_items):
    ...
    # Retrieve top 45 similar train nodes for few-shot examples
    retriever = index.as_retriever(similarity_top_k=45)
...
with open('rag4re_predictions_45shot_rag.json', 'w') as out_f:
    json.dump(outputs, out_f, indent=2)

# Evaluation
wandb.init(project="relation-extraction", name="RAG4RE_45shot_RAG")
...
print(f"\nEvaluation RESULTS for 45-shot + RAG prompting:")
...
excel_filename = 'relation_extraction_results_45shot_rag.xlsx'
