...
for idx, dev_item in enumerate(dev_items):
    ...
    # Retrieve top 50 similar train nodes for few-shot examples
...
with open('rag4re_predictions_50shot_rag_midSizeData.json', 'w') as out_f:
    json.dump(outputs, out_f, indent=2)

# Evaluation
wandb.init(project="relation-extraction", name="RAG4RE_50shot_RAG_completeData")
...
print(f"\nEvaluation RESULTS for 50-shot + RAG prompting:")
...
excel_filename = 'relation_extraction_results_50shot_rag_midSizeData.xlsx'
